...
export const mockInboxes: Inbox[] = [
  ...
  { id: 'inbox-1', clientId: 'client-1', domainId: 'domain-1', workspaceId: 'ws-techflow-1', email: 'sarah@techflow.io', firstName: 'Sarah', lastName: 'Chen', status: 'active', dailySendLimit: 50, createdAt: daysAgo(38) },
  { id: 'inbox-2', clientId: 'client-1', domainId: 'domain-1', workspaceId: 'ws-techflow-1', email: 'mike@techflow.io', firstName: 'Mike', lastName: 'Johnson', status: 'active', dailySendLimit: 50, createdAt: daysAgo(38) },
  { id: 'inbox-3', clientId: 'client-1', domainId: 'domain-1', workspaceId: 'ws-techflow-1', email: 'jordan@techflow.io', firstName: 'Jordan', lastName: 'Smith', status: 'active', dailySendLimit: 45, createdAt: daysAgo(35) },
  { id: 'inbox-4', clientId: 'client-1', domainId: 'domain-2', workspaceId: 'ws-techflow-2', email: 'sarah@techflow-mail.com', firstName: 'Sarah', lastName: 'Chen', status: 'warming', warmupProgress: 65, createdAt: daysAgo(18) },
  { id: 'inbox-5', clientId: 'client-1', domainId: 'domain-2', workspaceId: 'ws-techflow-2', email: 'mike@techflow-mail.com', firstName: 'Mike', lastName: 'Johnson', status: 'warming', warmupProgress: 58, createdAt: daysAgo(18) },
  { id: 'inbox-6', clientId: 'client-1', domainId: 'domain-1', workspaceId: 'ws-techflow-1', email: 'sarah.chen@techflow.io', firstName: 'Sarah', lastName: 'Chen', status: 'pending_approval', createdAt: daysAgo(1) },
  { id: 'inbox-6a', clientId: 'client-1', domainId: 'domain-1', workspaceId: 'ws-techflow-1', email: 'mike.j@techflow.io', firstName: 'Mike', lastName: 'Johnson', status: 'pending_approval', createdAt: daysAgo(1) },
  { id: 'inbox-6b', clientId: 'client-1', domainId: 'domain-1', workspaceId: 'ws-techflow-1', email: 'j.smith@techflow.io', firstName: 'Jordan', lastName: 'Smith', status: 'pending_approval', createdAt: daysAgo(1) },
  { id: 'inbox-6c', clientId: 'client-1', domainId: 'domain-1', workspaceId: 'ws-techflow-1', email: 'team@techflow.io', firstName: 'Team', lastName: 'TechFlow', status: 'rejected', createdAt: daysAgo(2) },
  { id: 'inbox-6d', clientId: 'client-1', domainId: 'domain-2', workspaceId: 'ws-techflow-2', email: 'jordan@techflow-mail.com', firstName: 'Jordan', lastName: 'Smith', status: 'pending_approval', createdAt: daysAgo(1) },
  // GrowthMetrics inboxes
  { id: 'inbox-7', clientId: 'client-2', domainId: 'domain-4', workspaceId: 'ws-growth-1', email: 'alex@growthmetrics.co', firstName: 'Alex', lastName: 'Rivera', status: 'active', dailySendLimit: 50, createdAt: daysAgo(26) },
  { id: 'inbox-8', clientId: 'client-2', domainId: 'domain-4', workspaceId: 'ws-growth-1', email: 'casey@growthmetrics.co', firstName: 'Casey', lastName: 'Morgan', status: 'active', dailySendLimit: 50, createdAt: daysAgo(26) },
  { id: 'inbox-9', clientId: 'client-2', domainId: 'domain-5', workspaceId: 'ws-growth-2', email: 'alex@gm-connect.io', firstName: 'Alex', lastName: 'Rivera', status: 'active', dailySendLimit: 40, createdAt: daysAgo(23) },
  { id: 'inbox-10', clientId: 'client-2', domainId: 'domain-5', workspaceId: 'ws-growth-2', email: 'casey@gm-connect.io', firstName: 'Casey', lastName: 'Morgan', status: 'warming', warmupProgress: 82, createdAt: daysAgo(10) },
  { id: 'inbox-10a', clientId: 'client-2', domainId: 'domain-4', workspaceId: 'ws-growth-1', email: 'alex.r@growthmetrics.co', firstName: 'Alex', lastName: 'Rivera', status: 'pending_approval', createdAt: daysAgo(1) },
  { id: 'inbox-10b', clientId: 'client-2', domainId: 'domain-4', workspaceId: 'ws-growth-1', email: 'casey.m@growthmetrics.co', firstName: 'Casey', lastName: 'Morgan', status: 'pending_approval', createdAt: daysAgo(1) },
  { id: 'inbox-10c', clientId: 'client-2', domainId: 'domain-5', workspaceId: 'ws-growth-2', email: 'sales@gm-connect.io', firstName: 'Sales', lastName: 'Team', status: 'rejected', createdAt: daysAgo(3) },
  // CloudScale inboxes
  { id: 'inbox-11', clientId: 'client-4', domainId: 'domain-6', workspaceId: 'ws-cloud-1', email: 'david@cloudscale.dev', firstName: 'David', lastName: 'Park', status: 'active', dailySendLimit: 50, createdAt: daysAgo(12) },
  { id: 'inbox-12', clientId: 'client-4', domainId: 'domain-6', workspaceId: 'ws-cloud-1', email: 'emma@cloudscale.dev', firstName: 'Emma', lastName: 'Wilson', status: 'active', dailySendLimit: 50, createdAt: daysAgo(12) },
  { id: 'inbox-13', clientId: 'client-4', domainId: 'domain-7', workspaceId: 'ws-cloud-2', email: 'chris@cs-reach.com', firstName: 'Chris', lastName: 'Taylor', status: 'warming', warmupProgress: 35, createdAt: daysAgo(5) },
  { id: 'inbox-14', clientId: 'client-4', domainId: 'domain-7', workspaceId: 'ws-cloud-2', email: 'lisa@cs-reach.com', firstName: 'Lisa', lastName: 'Brown', status: 'pending_approval', createdAt: daysAgo(2) },
  { id: 'inbox-14a', clientId: 'client-4', domainId: 'domain-6', workspaceId: 'ws-cloud-1', email: 'david.p@cloudscale.dev', firstName: 'David', lastName: 'Park', status: 'pending_approval', createdAt: daysAgo(1) },
  { id: 'inbox-14b', clientId: 'client-4', domainId: 'domain-6', workspaceId: 'ws-cloud-1', email: 'emma.w@cloudscale.dev', firstName: 'Emma', lastName: 'Wilson', status: 'pending_approval', createdAt: daysAgo(1) },
  { id: 'inbox-14c', clientId: 'client-4', domainId: 'domain-6', workspaceId: 'ws-cloud-1', email: 'chris.t@cloudscale.dev', firstName: 'Chris', lastName: 'Taylor', status: 'pending_approval', createdAt: daysAgo(1) },
  { id: 'inbox-14d', clientId: 'client-4', domainId: 'domain-6', workspaceId: 'ws-cloud-1', email: 'lisa.b@cloudscale.dev', firstName: 'Lisa', lastName: 'Brown', status: 'pending_approval', createdAt: daysAgo(1) },
  { id: 'inbox-14e', clientId: 'client-4', domainId: 'domain-7', workspaceId: 'ws-cloud-2', email: 'info@cs-reach.com', firstName: 'Info', lastName: 'CloudScale', status: 'rejected', createdAt: daysAgo(3) },
];
